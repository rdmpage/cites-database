...
//----------------------------------------------------------------------------------------
function wikidata_get($url, $user_agent='', $content_type = '')
{	
	$data = null;
...
$this->props = array(
	...
	foreach ($work->message as $k => $v)
	{
		...
		switch ($k)
		{
			...
			// BioStor CSL-JSON
			case 'bhl_pages':
				// wikidata_get first element of page array
